  ...
  >
    <div class="about-content">
        ...
        <div class="sponsor-grid">
          <div class="sponsor-item alipay">
            <div class="qr-wrapper">
              ...
              <div class="qr-overlay">
                <span class="qr-text">Alipay Scan Code</span>
              </div>
            </div>
          ...
          <div class="sponsor-item wechat">
            <div class="qr-wrapper">
              ...
              <div class="qr-overlay">
                <span class="qr-text">WeChat Scan Code</span>
              </div>
            </div>
            <div class="sponsor-label">
      ...
      <div class="features-section">
        ...
        <div class="feature-grid">
          ...
          <div class="feature-card">
            ...
            <span class="feature-text">Refresh Status</span>
          </div>
          <div class="feature-card">
            <div class="feature-icon-wrapper">
              <el-icon><User /></el-icon>
            </div>
            <span class="feature-text">Multiple Account Management</span>
          </div>
          <div class="feature-card">
            <div class="feature-icon-wrapper">
          ...
          <div class="feature-card">
            ...
            <span class="feature-text">Delete Account</span>
          </div>
          <div class="feature-card">
            <div class="feature-icon-wrapper">
          ...
          <div class="feature-card">
            ...
            <span class="feature-text">Fetch Link</span>
          </div>
          <div class="feature-card">
            <div class="feature-icon-wrapper">
      ...
      <div class="footer-section">
        ...
        <p class="disclaimer">
          This software only for learning and exchange use, please do not use for commercial purposes
        </p>
      </div>
    </div>
  </el-dialog>
