<template>
  ...
  >
    ...
    <div v-else-if="stats">
      <el-row :gutter="20">
        <el-col :span="8">
          <el-statistic title="Account Total" :value="stats.total_accounts" />
        </el-col>
        <el-col :span="8">
          <el-statistic title="Active Account" :value="stats.active_accounts" />
        </el-col>
        <el-col :span="8">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-statistic 
            title="Operation Successful Rate" 
        ...
        <el-col :span="12">
          <el-statistic 
            title="Credits Reset Successful Rate" 
      ...
      <el-descriptions :column="1" border>
        <el-descriptions-item label="Total Operation Count">
          {{ stats.total_operations }}
        </el-descriptions-item>
        
        <el-descriptions-item label="Total Reset Count">
          {{ stats.total_resets }}
        </el-descriptions-item>
...
async function loadStats() {
  ...
  try {
    ...
    ElMessage.error(`Loading Statistics failed: ${error}`);
  } finally {
    loading.value = false;
  }
}
